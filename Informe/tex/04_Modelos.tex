...
\lstinputlisting[language=Python, breaklines=true, caption={ Modelos de regresión con hiperparámetros utilizados.}]{./code/regresionModelHyperparam.py}

\subsection{Resultados iniciales en validación (70/30)}

Las métricas se calcularon sobre el precio transformado con \texttt{log1p} (ver Sección~\ref{sec:preprocesamiento}).
