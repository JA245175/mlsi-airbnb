...
\begin{itemize}
    ...
    \item \textbf{name} Esta Columna fue eliminada del dataset debido a que contiene texto libre que no aporta valor predictivo directo en este enfoque y podría introducir ruido o sobreajuste.
    \item \textbf{host\_id} Análogo a name.
    \item \textbf{host\_name} Análogo a name.
    \item \textbf{id} Análogo a name. 
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{lc}
        ...
        \midrule
        \texttt{reviews\_per\_month} & Replazar \text{NaN} por 0                    \\
        \texttt{last\_review}        & Se remplaza por la creación de \texttt{days\_since\_last\_review} \\
